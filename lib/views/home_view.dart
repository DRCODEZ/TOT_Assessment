...
class _HomeViewState extends State<HomeView> {
  ...
  List<Widget> pages = [HomeWidget(), BookmarkView(),];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: const Drawer(),
      body: IndexedStack(
        children: pages, index: _currentIndex
      ),
...
class HomeWidget extends StatelessWidget {
  ...
  // ) : _recipeManager = recipeManager, _pageController = pageController, super(key: key);
